...
function buildFactors(log: ExplainLog, targetStats: TargetStats): ExplanationFactor[] {
  ...
  factors.push({
    ...
    details: log.comboName
      ...
      : "No combo metadata was persisted, so AI Gate treated this as direct routing.",
  });
  ...
  factors.push({
    ...
    details: "Shows whether AI Gate cache or compression affected cost/latency for this route.",
  });
