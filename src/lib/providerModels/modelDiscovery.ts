...
// expose (as opposed to the flat `supportedThinkingEfforts` field AI Gate's own
...
// Maps common upstream synonyms onto AI Gate's canonical effort vocabulary
...
export function normalizeDiscoveredModels(models: unknown): SyncedAvailableModel[] {
  ...
  for (const item of items) {
    ...
    deduped.set(id, {
      ...
      ...(() => {
        // #7694/#8347: the flat field (AI Gate's own import format) wins verbatim when
