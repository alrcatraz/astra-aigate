...
import EndpointServicesTab from "./EndpointServicesTab";
...
const ENDPOINT_TABS: Array<{ value: EndpointTab; labelKey: string; icon: string }> = [
  ...
  { value: "services", labelKey: "tabServices", icon: "monitor_heart" },
  { value: "api-endpoints", labelKey: "tabApiEndpoints", icon: "list" },
...
export default function APIPageClient({ machineId }: Readonly<APIPageClientProps>) {
      ...
      if (data?.needsLogin && data?.authUrl) {
        ...
        setTailscaleNotice({
          ...
          message: translateOrFallback(
            ...
            "Complete the Tailscale login in the opened browser tab. AI Gate will retry automatically."
          ),
        });
      ...
      if (data?.funnelNotEnabled && data?.enableUrl) {
        ...
        setTailscaleNotice({
          ...
          message: translateOrFallback(
            ...
            "Enable Funnel for this device in the opened browser tab. AI Gate will keep polling."
          ),
        });
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {activeEndpointTab === "services" ? <EndpointServicesTab /> : null}
      {activeEndpointTab === "api-endpoints" ? <ApiEndpointsTab /> : null}
      ...
      {/* Endpoint Card — connection & tunnel management, shown on the APIs tab */}
          ...
          <div className="rounded-lg border border-blue-500/30 bg-blue-500/10 p-4">
            <p className="text-sm font-medium text-blue-300">
              {translateOrFallback(
                ...
                "Installs Tailscale on this machine and prepares AI Gate to enable Funnel."
              )}
            </p>
