        ...
        <div className="p-5">
          ...
          <p className="mt-1 text-sm text-text-muted">
            {L(
              ...
              "Scoped tokens that let the gateway CLI manage this server remotely (read/write/admin). Distinct from inference API keys — model access is managed in AI Gate → API Manager. The secret is shown once."
            )}
          </p>
        </div>
      </Card>
