...
export const CLI_TOOLS: Record<string, CliCatalogEntry> = {
  claude: {
    ...
    color: "#D97757",
    description: "Anthropic Claude Code CLI — ANTHROPIC_BASE_URL points to AI Gate",
  ...
  codex: {
    ...
    color: "#10A37F",
    description: "OpenAI Codex CLI — OpenAI-compatible base URL targets AI Gate",
  ...
  hermes: {
    ...
    guideSteps: [
      ...
      { step: 4, title: "Select Model", type: "modelSelector" },
      {
        ...
        desc: "Use the JSON block below as the OpenAI-compatible provider definition for AI Gate.",
      },
    ],
    codeBlock: {
      language: "json",
  ...
  qwen: {
    ...
    color: "#10B981",
    description: "Qwen Code CLI — current V4 OpenAI-compatible model provider via AI Gate",
    ...
    notes: [
      {
        type: "info",
        text: "AI Gate is registered under modelProviders.openai using Qwen Code's current bare-array V4 format.",
      },
      {
        type: "info",
...
OPENAI_API_KEY: "{{apiKey}}"`,
  ...
  omp: {
    ...
    description: "Oh My Pi terminal coding agent via AI Gate",
    configType: "custom",
    category: "agent",
    vendor: "OSS",
    acpSpawnable: true,
    ...
    notes: [
      {
        type: "info",
        text: "Oh My Pi reads custom OpenAI-compatible providers from ~/.omp/agent/models.yml. AI Gate adds itself as a provider with auto-discovery — models appear automatically in omp's /model menu.",
      },
      {
        type: "warning",
  ...
  letta: {
    ...
    notes: [
      {
        type: "info",
        text: "Letta CLI uses pi-ai which sends OpenAI-compatible requests. AI Gate configures it as an OpenAI provider with custom base URL.",
      },
      {
        type: "info",
        text: "CLI (Local Mode): AI Gate auto-configures ~/.letta/lc-local-backend/providers/auth.json. Use 'letta --info' to check if local mode is enabled.",
      },
      {
        type: "warning",
