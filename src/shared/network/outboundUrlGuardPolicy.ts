...
// cloud-metadata endpoints stay blocked. Defaults ON (AI Gate is local-first); operators
 ...
 * (AI Gate is local-first — local OpenAI-compatible providers should validate out of the
