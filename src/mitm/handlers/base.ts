 ...
 *   - forwarding to the AI Gate router (Next.js API)
 *   - SSE piping
...
export abstract class MitmHandlerBase {
   ...
   *   3. Call `this.fetchRouter(...)` for the AI Gate router round-trip.
  ...
  /**
   * Forward the prepared body to the AI Gate router (Next.js API).
