 ...
 * vs. applying AI Gate's own caching strategy.
 *
 ...
 * strategies) forced AI Gate to strip the client's markers and re-derive
 ...
 * @returns true if cache_control should be preserved, false if AI Gate should manage it
 */
