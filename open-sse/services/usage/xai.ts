 ...
 * self-track pattern — AI Gate sums the tokens it itself routed to this
 ...
 * MiMo self-track pattern above — AI Gate sums the tokens it itself routed
