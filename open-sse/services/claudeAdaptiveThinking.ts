 ...
 * (Anthropic's current model migration guidance). AI Gate can still produce a manual
 ...
 * This contract is verified for AI Gate's two direct Anthropic API providers:
