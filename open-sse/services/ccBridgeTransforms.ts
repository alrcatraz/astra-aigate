 ...
 *
 * Goal: ensure the final request body AI Gate sends to Anthropic's
 ...
 * proven against the live AI Gate deployment (call log
...
/**
 * Compute the `cc_version` suffix per the AI Gate native-OAuth algorithm:
