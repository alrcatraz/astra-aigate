...
// #1731v2 guard: a provider circuit-breaker-open response (503 + `X-AI-Gate-Provider-Breaker`
// header / `provider_circuit_open` error code, see providerCircuitOpenResponse) is an AI Gate
