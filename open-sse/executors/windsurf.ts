 ...
 *
 * AI Gate → Windsurf model-ID mapping lives in MODEL_ID_MAP below.
 */
...
//
// This table handles only AI Gate-style backwards-compat aliases where users
...
// AI Gate uses dot-notation user IDs (e.g. "gpt-5.5-high").
