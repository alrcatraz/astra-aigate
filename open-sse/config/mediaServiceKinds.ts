...
import { RERANK_PROVIDERS } from "./rerankRegistry.ts";
import { MODERATION_PROVIDERS } from "./moderationRegistry.ts";
...
export const MEDIA_KIND_REGISTRIES = {
  ...
  audioTranslation: AUDIO_TRANSLATION_PROVIDERS,
