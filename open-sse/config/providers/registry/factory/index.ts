...
// local `droid` CLI. AI Gate already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through AI Gate.
//
...
// back to stored CLI credentials only when omitted. AI Gate does NOT read
