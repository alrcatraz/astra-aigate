 ...
 *
 *   1. The client (AI Gate) generates an ephemeral RSA keypair.
 ...
 *   5. AI Gate decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + AI Gate conventions. `fetch` is intentionally the
